...
var $author$project$Main$viewMiniature = F2(
	function (model, item) {
		...
		if (_v0.$ === 'Nothing') {
			...
			var cursorStyle = isDragging ? 'grabbing' : 'grab';
			return A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
									...
									[
										...
										_List_fromArray(
											[
												...
												A2($elm$html$Html$Attributes$style, 'color', '#1a2947')
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Cliquer pour agrandir, glisser pour placer.')
											]))
									])),
								A2(
								$elm$html$Html$div,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Selection : ' + ($author$project$Main$selectedBadgeLabel(model.selectedPropositionId) + (' | Expanded : ' + ($author$project$Main$selectedBadgeLabel(model.expandedPropositionId) + ' | touche A = agrandir'))))
					])),
				A2(
				$elm$html$Html$p,
				_List_fromArray(
