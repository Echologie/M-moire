...
var $author$project$Test$viewExpandedOverlay = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$Test$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Test$viewMiniCard,
				model.expanded ? $author$project$Test$viewExpandedOverlay : $elm$html$Html$text('')
			]));
};
